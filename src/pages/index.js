        ...
        <Container>
          <div className="climate-sec-inner">
            <div className="climate-box-inner">
              ...
              <p>
                Buildings consume 40% of energy worldwide as 21% of the greenhouse gases originate from them. This is the time to rethink the way communities are built. <br></br>

                Climate hub is “the solution” in the current scenario. Climate hubs are closed ecological systems which do not rely on matter exchange with anything from outside of the system. The waste generated by one species is used by another species forming closely knit biological communities within themselves. <br></br>

                New ecosystems are created by making the place conducive for various organisms thereby increasing the biodiversity of the place. Homes that are built and integrated with nature enhance the quality of bionetworks such as soil, air and water including the surrounding neighborhoods & environment.
            ...
            <div className="climate-box-books">
              <Row className="climate-inner-row">
                ...
                <Col className="box-right-con climate-box-img">
                  ...
                  <h6 className="mission-sub-text">
                    A consolidation of gross study with focus on the current situation due to several man-made developments across Monroe County boiling down to Back Creek. This includes mapping of climatic and geological changes that occurred over a period and its impact on natural resources. Fact remains that West Virginia ranks 49 out of 50 states in the United States Sustainability Development Index.
                  </h6>
              ...
              <Row className="climate-inner-row">
                ...
                <Col className="box-right-con">
                  ...
                  <h6 className="mission-sub-text">
                    Primary focus of this report is to constitute a solution framework and restore ecological balance with a broad roadmap towards environmental impact goals of CREST Foundation overlapped and measured in comparison with UN Sustainable Development Goals defined for Saudi Arabia.
                  </h6>
                  <a href="" className="readmore">
                    Read More...
                  </a>
