            ...
            <Col className="col-lg-8 col-sm-12">
              <div className="goal-section">
                ...
                >
                  ...
                  miles. Organic farms within these sustainable communities will
                  also support a farm-to-fork-to-farm model, allowing
                ...
                <p className="mission-sub-text">
                  ...
                  gas emissions. In the time it takes for food to be harvested
                  and reach the customer, fresh, alkaline food turns acidic.
                  Regular consumption of acidic food increases the risk of
                  cancer and other gastroenterological diseases.
                </p>
                <p className="mission-sub-text">
                  Investing in climate-smart agriculture, nutritional food
                  security, integrated pest management, and pollinator health
                  and protection restores soil health. Regular access to fresh
                  produce reduces dependence on refrigeration to store food.
                  Improving soil health helps sequester carbon back into the
                  Earth.
                </p>
              </div>
            </Col>
