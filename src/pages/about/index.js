      ...
      <div>
        ...
        <Container className="about-sub" id="ethos">
          <Row>
            ...
            <Col className="col-lg-8 col-sm-12">
              ...
              <div className="goal-section">
                <h4 className="over-heading">Human Wellbeing Can Save the Planet</h4>
                <br></br>
        ...
        <Container className="about-sub" id="intention">
          <Row>
            <Col className="col-lg-4 col-12">
              <div className="goal-img">
                <StaticImage src="../../images/about/Our-Intention.png" alt="" />
              </div>
            </Col>
            <Col className="col-lg-8 col-sm-12">
              ...
              <div className="goal-section">
                ...
                <h4 className="over-heading">Supply Chains and Carbon Footprints</h4>
                <br></br>
