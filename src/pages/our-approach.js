    ...
    <div>
      <Container className="about-sub">
        <Row>
          ...
          <Col className="col-lg-8 col-sm-12">
            <div className="goal-section">
              <h3
                className="mission-subheading heading-color mb-20"
                data-sal="slide-up"
                data-sal-duration="1000"
              >
        ...
        <Row>
          <Col className="col-lg-4 col-12">
            <div
              className="approach-imgs"
              data-sal="slide-up"
              data-sal-duration="1000"
            >
              <StaticImage
                src="../images/our-approach/Crest-icons.jpg"
                alt=""
              />
            </div>
          </Col>
        ...
        <Row>
          <Col className="col-lg-6 col-12">
            <div className="approach-section-planet">
              <div className="planet-box">
                <div
                  className="approach-heading mission-subheading"
                  data-sal="slide-up"
                  data-sal-duration="1000"
                >
                  Planet
                ...
                <ul data-sal="slide-up" data-sal-duration="1000">
                  ...
                  <li className="mission-sub-text">Water Positive Community</li>
                  <li className="mission-sub-text">
              ...
              <div className="planet-box">
                <div className="approach-heading mission-subheading"></div>
                <ul data-sal="slide-up" data-sal-duration="1000">
                  <li className="mission-sub-text">Resources Efficieny</li>
                  <li className="mission-sub-text">Improved Air Quality</li>
                  <li className="mission-sub-text">Carbon Sequestration</li>
                  <li className="mission-sub-text">Renewable Energy</li>
                  <li className="mission-sub-text">Innovative Technologies</li>
                </ul>
              </div>
            </div>
          </Col>
          ...
          <Col className="col-lg-3 col-12">
            <div className="approach-section-planets">
              ...
              <ul data-sal="slide-up" data-sal-duration="1000">
                <li className="mission-sub-text">Wellbeing</li>
                <li className="mission-sub-text">Inclusive Economic Growth</li>
                <li className="mission-sub-text">Equal Opportunties</li>
              </ul>
            </div>
          </Col>
          <Col className="col-lg-3 col-12">
            <div className="approach-section-planets">
              ...
              <ul data-sal="slide-up" data-sal-duration="1000">
                <li className="mission-sub-text">Eco Habitats</li>
              </ul>
            </div>
          </Col>
        </Row>
